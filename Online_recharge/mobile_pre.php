...
<div class="container">
	...
	<div class="details">
		<h1>Viewing Mobile Prepaid Details</h1>
		<?php 
			$sql="SELECT * FROM mobile_pre";
			$res=$con->query($sql);
			if($res->num_rows > 0)
			{
				echo "<table border='1px'>
					<tr>
						<th>SNO</th>
						<th>PREPAID MOBILE NUMBER</th>
						<th>PREPAID OPERATOR</th>
						<th>PREPAID CIRCLE</th>
